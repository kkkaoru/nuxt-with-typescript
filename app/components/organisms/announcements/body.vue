<template>
  <pre class="announcement-body" v-html="parsedEmoji"></pre>
</template>
<script lang="ts">
...
export default defineComponent({
  ...
  setup(props) {
    const parsedAncor: string = parseAnchorTag(props.body, 'announcement-body__link');
    const parsedEmoji: string = parseEmoji(parsedAncor, 'announcement-body__emoji');
    return { parsedEmoji };
  },
});
</script>
