<template>
  <ul class="content-images">
    <li v-for="(imageUrl, index) in imageUrls" :key="index" class="content-images__container">
      <div class="content-images__inner">
        <client-only>
          <lazy-component>
            <img class="content-images__image" :src="imageUrl" :alt="`${name}_${index}`" />
          </lazy-component>
        </client-only>
      </div>
    </li>
